        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Anti-discrimination</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Disability support</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Airbnb your home</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:underline">AirCover for Hosts</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Hosting resources</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Community forum</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Hosting responsibly</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:underline">New features</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Airbnb.org</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:underline">Disaster relief</a></li>
